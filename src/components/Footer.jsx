    ...
    <footer className="bg-[#1b3a6b] text-crema">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          ------------------------------------------------------------ */}
          <div>
            <Link to="/" className="flex items-center gap-2 text-dorado font-bold text-xl mb-4">
          ...
          <address className="not-italic">
            ...
            <ul className="flex flex-col gap-3 list-none text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:contacto@ciae.edu" className="hover:text-dorado transition-colors duration-200">
                  contacto@ciae.edu
                </a>
              </li>
              {/* Teléfono */}
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+18005552423" className="hover:text-dorado transition-colors duration-200">
                  +1 800 555 CIAE
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" aria-label="Cambiar idioma" className="hover:text-dorado transition-colors duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                className="w-4 h-4">
            ...
            <a href="#" aria-label="Compartir" className="hover:text-dorado transition-colors duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                className="w-4 h-4">
